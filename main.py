...
class User(UserMixin, db.Model):
    ...
    # Add parent relationship to child BlogPost
    posts = relationship("BlogPost", back_populates="author")
    # Add parent relationship to child Comment
...
class BlogPost(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    # Add child relationship to parent User
...
class Comment(db.Model):
    ...
    # Add child relationship to parent BlogPost
...
def register():
    ...
    if form.validate_on_submit():
        ...
        flash("A user with that email address already exists. Log in instead:")
